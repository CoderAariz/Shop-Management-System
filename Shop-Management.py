...
try:
    ...
    def register():
        ...
        reg_name=Label(register_screen,text='Name:')
        reg_name.pack()
        global reg_name_ent
        ...
        reg_pas.pack()
        global reg_pas_ent
        reg_pas_ent=Entry(register_screen)
        reg_pas_ent.pack()
        Label(register_screen, text="").pack()
    ...
    def registration():
        ...
        con.commit()
        reg_name_ent.delete(END,0)
        reg_pas_ent.delete(END,0)
    ...
    def initial():
        ...
        search_btn=Button(initial_screen,text='Search',height=3,width=7,bg='yellow')
        search_btn.pack()
